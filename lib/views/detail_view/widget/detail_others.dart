...
class DetailOthers extends StatelessWidget {
  final String article;

  const DetailOthers({Key key, this.article}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return StaggeredGridView.countBuilder(
      crossAxisCount: 2,
      itemCount: listviewmodel.technologyArticle.length,
      itemBuilder: (BuildContext context, int index) {
        var arti = listviewmodel.technologyArticle[index];
        return Padding(
